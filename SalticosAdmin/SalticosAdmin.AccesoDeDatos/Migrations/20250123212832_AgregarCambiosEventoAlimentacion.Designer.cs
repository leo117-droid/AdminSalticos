...
namespace SalticosAdmin.AccesoDeDatos.Migrations
{
    ...
    [Migration("20250123212832_AgregarCambiosEventoAlimentacion")]
    partial class AgregarCambiosEventoAlimentacion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.Evento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.EventoAlimentacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.EventoInflable", b =>
                {
                    ...
                    b.HasIndex("IdInflable");

                    b.ToTable("EventoInflable");
                });

            modelBuilder.Entity("SalticosAdmin.Modelos.EventoMobiliario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.EventoServicioAdicional", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.Tarea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.Usuario", b =>
                {
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.Evento", b =>
                {
                    b.HasOne("SalticosAdmin.Modelos.Cliente", "Cliente")
                        .WithMany()
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.EventoAlimentacion", b =>
                {
                    ...
                    b.HasOne("SalticosAdmin.Modelos.Evento", "Evento")
                        .WithMany()
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.EventoInflable", b =>
                {
                    ...
                    b.HasOne("SalticosAdmin.Modelos.Inflable", "Inflable")
                        .WithMany()
                        .HasForeignKey("IdInflable")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("Evento");

                    b.Navigation("Inflable");
                });
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.EventoMobiliario", b =>
                {
                    ...
                    b.HasOne("SalticosAdmin.Modelos.Mobiliario", "Mobiliario")
                        .WithMany()
                        .HasForeignKey("IdMobiliario")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.EventoServicioAdicional", b =>
                {
                    ...
                    b.HasOne("SalticosAdmin.Modelos.ServicioAdicional", "ServicioAdicional")
                        .WithMany()
                        .HasForeignKey("IdServicioAdicional")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("SalticosAdmin.Modelos.EventoVehiculo", b =>
                {
                    ...
                    b.HasOne("SalticosAdmin.Modelos.Vehiculo", "Vehiculo")
                        .WithMany()
