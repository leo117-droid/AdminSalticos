...
namespace SalticosAdmin.Areas.Admin.Controllers
{
    ...
    public class InformeController : Controller
    {
        ...
        {
            // Obtener inflables más utilizados
            List<Inflable> inflablesMasUtilizados = _informeServicio.ObtenerInflablesMasUtilizados();
            ...
            using (var memoryStream = new MemoryStream())
            {
                ...
                // Título del informe
                document.Add(new Paragraph("Informe de Inflables Más Utilizados"));
                ...
                table.AddCell("Cantidad de Veces Utilizado");

                // Agregar los inflables a la tabla
                foreach (var inflable in inflablesMasUtilizados)
                {
                ...
                // Descargar el PDF
                return File(memoryStream.ToArray(), "application/pdf", "Informe_Inflables.pdf");
            }
        }
    }
}
