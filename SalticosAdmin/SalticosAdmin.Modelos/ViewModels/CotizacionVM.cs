namespace SalticosAdmin.Modelos.ViewModels
{
    ...
    public class CotizacionVM
    {
        ...
        public List<TarifasTransporte> TarifasTransporte { get; set; } // Lista de tarifas
        ...
        public List<TarifasTransporte> TarifaTransporteSeleccionada { get; set; } // Nueva propiedad
