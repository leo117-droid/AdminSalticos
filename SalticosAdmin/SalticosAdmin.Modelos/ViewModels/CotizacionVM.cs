namespace SalticosAdmin.Modelos.ViewModels
{
    ...
    public class CotizacionVM
    {
        ...
        public List<TarifasTransporte> TarifasTransporte { get; set; } 
        ...
        public List<(Alimentacion Alimentacion, int Cantidad)> AlimentacionSeleccionada { get; set; } 

        public List<TarifasTransporte> TarifaTransporteSeleccionada { get; set; } 
