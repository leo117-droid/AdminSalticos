...
{
    public class CategoriaTamannoPage : Base
    {
        // Entrar gestión categoría tamaño
        ...
        By IrCategoriaTamannoBtnLocator = By.XPath("/html/body/div/main/section/div/div/div[3]/div/div/a");

        // Crear categoría tamaño
        By CrearNuevaCategoriaTamannoBtnLocator = By.XPath("/html/body/div/main/div[1]/div[2]/a");
        By NombreInputLocator = By.Id("nombre");
        By CrearBtnLocator = By.XPath("//*[@id=\"formCategoriaTamanno\"]/div/div[4]/div/button");

        By BuscarInputLocator = By.XPath("//*[@id=\"tblDatos_filter\"]/label/input");
        By NombreRegistroLocator = By.XPath("//*[@id=\"tblDatos\"]/tbody/tr/td[1]");

        By MsgNombreRepetidoLocator = By.XPath("/html/body/div[2]/div/div[3]");

        // Actualizar categoría tamaño
        By EditarBtnLocator = By.XPath("//*[@id=\"tblDatos\"]/tbody/tr[1]/td[2]/div/a[1]/i");
        By GuardarCambiosBtnLocator = By.XPath("//*[@id=\"formCategoriaTamanno\"]/div/div[4]/div/button");
        ...
        public CategoriaTamannoPage(IWebDriver driver) : base(driver)
        {
        ...
        public void GestionCategoriaTamanno()
        {
            ClickElementUsingJS(IrServiciosBtnLocator);
            Thread.Sleep(2000);
            Click(IrInflablesBtnLocator);
            Thread.Sleep(2000);
            Click(IrCategoriaTamannoBtnLocator);
        }


        public void AgregarCategoriaTamanno(String nombre)
        {
            Click(CrearNuevaCategoriaTamannoBtnLocator);
            Thread.Sleep(2000);
        ...
        public Boolean CategoriaTamannoEstaRegistrada(String nombre)
        {
        ...
        public void RegistrarCategoriaTamannoConNombreRepetido(String nombre)
        {
            Click(CrearNuevaCategoriaTamannoBtnLocator);
            Thread.Sleep(2000);
            Type(nombre + "\n", NombreInputLocator);
        ...
        public void ActualizarNombreCategoriaTamanno(String nombre, String nuevoNombre)
        {
            Type(nombre, BuscarInputLocator);
        ...
        public Boolean NombreCategoriaTamannoActualizado(String nombre)
        {
            Type(nombre, BuscarInputLocator);
        ...
        public void EliminarCategoriaTamanno(String nombre)
        {
            Type(nombre, BuscarInputLocator);
        ...
        public Boolean EstaCategoriaTamannoEliminado()
        {
